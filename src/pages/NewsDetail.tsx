    ...
    <div className="flex flex-col min-h-screen bg-zinc-950">
      ...
      <main className="flex-1 pt-28 pb-16 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          {notFound && (
            <div>
              <p className="text-white/40 text-sm mb-4">Новость не найдена</p>
              <button onClick={() => navigate("/news")} className="text-white text-sm hover:text-white/70 transition-colors">
