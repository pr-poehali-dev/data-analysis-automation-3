    ...
    <div className="flex flex-col min-h-screen bg-zinc-950">
      ...
      <main className="flex-1 pt-28 pb-16 px-6">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-white text-3xl font-light mb-2">Блог</h1>
          <p className="text-white/40 text-sm mb-4">Полезные статьи и советы</p>
          ...
          {!loading && posts.length === 0 && (
            <p className="text-white/30 text-sm">Статей пока нет</p>
          )}
